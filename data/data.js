...
export const projects = [
  {
    ...
    description:
      "Made in 2 parts. A game website made using VanillaJS and helper website made using react which include data like score, highscores and stripe payments for buying skins for game.",
    techstack: [
      "VanillaJs",
      "ReactJs",
      "Stripe",
  ...
  },
  {
    title: "Bloggator",
    description:
      "A highly scalable MERN website where people write blogs. You can follow your favorite bloggers, save there blogs and write your blogs as well.MondoDB is used as the NoSql database with security features to protect users password. Writing blog is made easy using markdown style of writing.",
  ...
  },
  {
    ...
    description:
      "Game made using VanillaJS, lets you change difficulty depending on your comfort and stores your score.",
  ...
  },
  {
    ...
    description:
      "This website show the almost all the data related to 200 cryptocurrencies aand shows you news happening around the crypto world",
